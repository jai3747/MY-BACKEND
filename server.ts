...
// // Health check endpoint - Changed to match Kubernetes probe
...
const corsOptions: cors.CorsOptions = {
  origin: process.env.NODE_ENV === 'production'
    ? ['http://awsaparna123.xyz', 'https://awsaparna123.xyz', 'http://api.awsaparna123.xyz', 'https://api.awsaparna123.xyz', 'http://localhost:3000']
    : true,
  methods: ['GET', 'POST', 'DELETE', 'OPTIONS'],
  allowedHeaders: ['Content-Type', 'Authorization'],
  credentials: false,
